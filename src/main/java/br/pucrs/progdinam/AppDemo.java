...
//		System.out.println("Distancia (Prog Dinam) = " + res);
		...
		System.out.println("Maior valor (Knapsack Recursivo) = " + resCont.getResult()[0] );
		System.out.println("Capacidade da Mochila (Knapsack Recursivo) = " + 165);
		System.out.println("Número de Iterações (Knapsack Recursivo) = " + resCont.getIteracoes());
		System.out.println("Número de Instruções (Knapsack Recursivo) = " + resCont.getInstrucoes());
		...
		System.out.println("Maior valor (Knapsack Recursivo) = " + resCont.getResult()[0] );
		System.out.println("Capacidade da Mochila (Knapsack Recursivo) = " + 190);
		System.out.println("Número de Iterações (Knapsack Recursivo) = " + resCont.getIteracoes());
		System.out.println("Número de Instruções (Knapsack Recursivo) = " + resCont.getInstrucoes());
	}
}
